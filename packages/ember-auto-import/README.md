...
- `entryInjectables` - _list of strings or string arrays, defaults to []_. This is a list of JavaScript code that will be injected into the entrypoint files generated by ember-auto-import. This is useful for using advanced Webpack features like [`__webpack_public_path__`][webpack-public-path] or [`__webpack_nonce__`][webpack-nonce].
